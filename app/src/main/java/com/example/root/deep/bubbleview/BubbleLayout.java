 ...
 */
package com.example.root.deep.bubbleview;
...
public class BubbleLayout extends ViewGroup implements BubbleView.MoveListener {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < sortResult.size(); i++) {
            ...
            if (i == 0) {
                Rect newRect = getBounds(padding, 0, child.getMeasuredWidth(), child.getMeasuredHeight());
            ...
            if (i == 1) {
                ...
                Rect newRect = getBounds(2 * padding +lastRect.height(),  padding, child.getMeasuredWidth(), child.getMeasuredHeight());
                child.layout(newRect.left, newRect.top, newRect.right, newRect.bottom);
                bubbleInfo.setRect(newRect);
            }
            if (i == 2) {
            ...
            if (i == 3) {
                Rect lastRect=sortResult.get(i-1).getmBubbleInfo().getRect();
                Rect newRect = getBounds(0, lastRect.bottom-lastRect.height()/3 , child.getMeasuredWidth(), child.getMeasuredHeight());
                child.layout(newRect.left, newRect.top, newRect.right, newRect.bottom);
                bubbleInfo.setRect(newRect);
            }
            if (i == 4) {
